...
import AddProfile from "./components/Screens/Profile/AddProfile";
import AddProject from "./components/Screens/Profile/AddProject";
import ViewProfile from "./components/Screens/Profile/ViewProfile.jsx";
  ...
  return (
    ...
    <userContext.Provider value={{ state, dispatch }}>
      <div className="grid-container">
        ...
        <main>
          <Switch>
            <Route path="/viewprofile" component={ViewProfile} exact/>
            <Route path="/addproject" component={AddProject} exact/>
            <Route path="/addprofile" component={AddProfile} exact/>
